...
<script lang="ts">
	...
	name: "Joe Betesh",
	role: "Co-founder & CEO",
	image: "/generated/image-a-casual-portrait-of-a-credible-male-fou.webp"
};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"Wholesale companies spend too much time running the business—and not enough time growing it. We started Commerce to fix that."`}
			/>
